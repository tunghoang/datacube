...
def gen_dataset_doc(tif_path):
    ...
    yaml_path = r'/home/odc/Workspace/nfs/TEMPLATE_DOC/dataset.yaml' # path to template doc
    ...
    template['measurements'] = {product: {'path': tif_path}}
...
if __name__ == '__main__':
    data_folder = r'/home/odc/Workspace/nfs/DATA/DATA_10KM_daily/'
    list_product = [
        'CAPE',
        'EWSS',
        'IE',
